  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <nav className="flex justify-between items-center px-8 py-6 max-w-7xl mx-auto">
        <Link to="/" className="text-2xl font-bold text-blue-600 no-underline tracking-tight">
          OneFlow
        </Link>
        ...
        <button
          className="md:hidden text-2xl text-gray-900 bg-transparent border-0"
      ...
      <section className="px-8 py-24 max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        <div className="max-w-2xl">
          <h1 className="text-6xl leading-tight font-extrabold text-gray-900 mb-6">
            OneFlow.<br />
            Plan, Execute & Bill. All In One Place
          </h1>
          <p className="text-xl text-gray-600 mb-10 leading-relaxed">
            Streamline Projects, Maximize Profitability, Unify Your Workflow. The modular system
            that takes you from planning to billing without the chaos.
          </p>
      ...
      <section id="features" className="bg-white px-8 py-24 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-7xl mx-auto">
          <div className="text-left p-8 bg-white border border-gray-200 rounded-xl hover:border-blue-600 hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <p className="text-gray-600 leading-relaxed">
              Create detailed project plans, assign tasks, and set milestones with our intuitive
              interface.
            </p>
          </div>
          <div className="text-left p-8 bg-white border border-gray-200 rounded-xl hover:border-blue-600 hover:shadow-xl transition-all hover:-translate-y-1">
          ...
          <div className="text-left p-8 bg-white border border-gray-200 rounded-xl hover:border-blue-600 hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <p className="text-gray-600 leading-relaxed">
              Convert project hours into professional invoices and get paid faster with integrated
              payments.
            </p>
          </div>
        </div>
